...
# ── Internal endpoint untuk inter-service communication ──────────────────────
...
def get_users_batch(payload: UserIdsRequest, db: Session = Depends(get_db)):
    """
    Endpoint internal untuk Microservices.
    Menerima list user_id dan mengembalikan data user-nya sekaligus.
    Dipakai oleh Blog Service untuk Data Stitching (API Composition).
    """
